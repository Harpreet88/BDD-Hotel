...
public class RegStepDef {
	...
	public void openBrowsser() {
		String driverPath = "D:\\3000172_Kishanjot_Singh\\BDDCucumberSelenium\\chromedriver.exe";
		System.setProperty("webdriver.chrome.driver", driverPath+"chromedriver.exe");	
		driver = new ChromeDriver();
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		rpg = new RegPageFactory(driver);

		driver.get("file://D:/Kish/BDD/Set-A_Module3_Conference/Web%20Pages%20Conference%20Registration/ConferenceRegistartion.html");
	}
	...
	rpg.setPffName("Anmol");
	rpg.setPflName("Yadav");
	rpg.setPfEmail("anmol@gmail.com");
	rpg.setPfPhoneNo("");
	rpg.setPfSubmit();
	}
	...
	public void navigate_to_payment_page() throws Throwable {
		driver.navigate().to("file:///D:/168360_Devi_Ratnala/BDD/Set-A_Module3_Conference/Web%20Pages%20Conference%20Registration/PaymentDetails.html\"");
	}
	@After
